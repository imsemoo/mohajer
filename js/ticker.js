    ...
    return this.each(function () {
      ...
      function a() {
        s(),
          ...
          e(f.dom.wrapperID).children().remove(),
          e(f.dom.wrapperID).append(
            '<div id="' +
              f.dom.tickerID.replace("#", "") +
              '" class="ticker"><div id="' +
              f.dom.titleID.replace("#", "") +
              '" class="ticker-title"><span><!-- --></span></div><p id="' +
              f.dom.contentID.replace("#", "") +
              '" class="ticker-content"></p><div id="' +
              f.dom.revealID.replace("#", "") +
              '" class="ticker-swipe"><span><!-- --></span></div></div>'
          ),
          e(f.dom.wrapperID)
            .removeClass("no-js")
            .addClass("ticker-wrapper has-js " + o.direction),
          e(f.dom.tickerElem + "," + f.dom.contentID).hide(),
          o.controls &&
            (e(f.dom.controlsID).on(
      ...
      function s() {
        if (0 == f.contentLoaded)
          if (o.ajaxFeed)
                        ...
                        for (
                          ...
                          "title" == xmlItems.childNodes[c].nodeName
                            ...
                            : "link" == xmlItems.childNodes[c].nodeName &&
                              (s = xmlItems.childNodes[c].lastChild.nodeValue),
                            a !== !1 &&
                              "" != a &&
                              s !== !1 &&
            ...
            if (!(e(n + " LI").length > 0))
              return (
                l("Couldn't find HTML any content for the ticker to use!"), !1
              );
      ...
      function c() {
        ...
        e(f.dom.revealID).css(o.direction, t + "px"),
          "fade" == o.displayType
            ...
            : "scroll" == o.displayType ||
              e(f.dom.revealElem).show(0, function () {
                e(f.dom.contentID)
                  ...
                  .show(),
                  (contentWindowSize =
                    e(f.dom.tickerID).width() - e(f.dom.titleID).width() - 20),
                  e(f.dom.contentID).width() <= contentWindowSize
                    ? ((animationAction =
                        "right" == o.direction
                    ...
                    : ((delay_scroll = contentWindowSize / o.speed),
                      (time_scroll =
                        e(f.dom.contentID).width() / o.speed - delay_scroll),
                      (animationAction =
                        "right" == o.direction
                      ...
                      e(f.dom.revealID)
                        .css("margin-" + o.direction, "0px")
                        .delay(20)
                        .animate(animationAction, delay_scroll, "linear"),
                      (scrollSize =
                        e(f.dom.titleID).width() +
                        20 -
                        e(f.dom.contentID).width() +
                        contentWindowSize),
                      (animationAction_scroll =
                        "right" == o.direction
                          ? { right: scrollSize + "px" }
                          : { left: scrollSize + "px" }),
                      e(f.dom.contentID)
      ...
      function p() {
        (f.play = !1),
          ...
          e(f.dom.revealID + "," + f.dom.revealElem).hide(),
          e(f.dom.wrapperID)
            .find(f.dom.titleID + "," + f.dom.titleElem)
            .show()
            .end()
            .find(f.dom.contentID)
            .show();
      }
      function u() {
